...
function Tone({ children, tone = "neutral" }: { children: React.ReactNode; tone?: "neutral" | "risk" | "good" | "learning" | "warn" }) { return <span className={`tone ${tone}`}>{children}</span>; }
