...
export function CashFlowApp() {
  ...
  return <main className="app-shell">
    ...
    <section className="content">
      ...
      {dataSource === "connected-empty" && <div className="data-banner"><Sparkles size={16}/><span>Your connected account has no transactions yet. Showing sample data — add a transaction to see live insights.</span></div>}
